...
- `q011` `hybrid`: retrieval-only run
- `q012` `hybrid`: retrieval-only run
- `q013` `hybrid`: expected official source not found in top 5
- `q014` `hybrid`: expected official source not found in top 5
...
- `q038` `hybrid`: expected official source not found in top 5
- `q039` `hybrid`: retrieval-only run
...
- `q046` `hybrid`: retrieval-only run
- `q047` `hybrid`: retrieval-only run
- `q048` `hybrid`: expected official source not found in top 5
...
- `q055` `hybrid`: expected official source not found in top 5
- `q056` `hybrid`: retrieval-only run
- `q057` `hybrid`: retrieval-only run
- `q058` `hybrid`: retrieval-only run
- `q059` `hybrid`: retrieval-only run
- `q060` `hybrid`: expected official source not found in top 5
- `q061` `hybrid`: expected official source not found in top 5
- `q062` `hybrid`: expected official source not found in top 5
- `q063` `hybrid`: retrieval-only run
- `q064` `hybrid`: retrieval-only run
- `q065` `hybrid`: retrieval-only run
- `q066` `hybrid`: retrieval-only run
- `q067` `hybrid`: retrieval-only run
- `q068` `hybrid`: retrieval-only run
- `q069` `hybrid`: retrieval-only run
- `q070` `hybrid`: retrieval-only run
...
- `q075` `hybrid`: expected official source not found in top 5
- `q076` `hybrid`: expected official source not found in top 5
...
- `q082` `hybrid`: expected official source not found in top 5
...
- `q090` `hybrid`: expected official source not found in top 5
...
- `q098` `hybrid`: expected official source not found in top 5
